...
public readonly record struct Market(string Name, string BaseCurrency, string QuoteCurrency, double? QuoteVolume24H,
    ...
    double PriceIncrement, double SizeIncrement, bool Restricted, double? VolumeUsd24H, double? LargeOrderThreshold,
    bool IsEtfMarket);